    ...
    create: (x, y) => {
      ...
      return {
        ...
        elements: [
          ...
          { id: item1, type: 'text', name: 'Dashboard', x: 0, y: 0, width: 200, height: 32, parentId: frameId, style: { backgroundColor: 'rgba(0,145,255,0.12)', borderRadius: 4 }, text: { content: 'Dashboard', fontSize: 14, fontWeight: 500, color: '#0091ff', textAlign: 'left', lineHeight: '32px' as any, letterSpacing: 0 } },
          { id: item2, type: 'text', name: 'Projects', x: 0, y: 0, width: 200, height: 32, parentId: frameId, text: { content: 'Projects', fontSize: 14, fontWeight: 400, color: '#8a8a8a', textAlign: 'left', lineHeight: '32px' as any, letterSpacing: 0 } },
          { id: item3, type: 'text', name: 'Settings', x: 0, y: 0, width: 200, height: 32, parentId: frameId, text: { content: 'Settings', fontSize: 14, fontWeight: 400, color: '#8a8a8a', textAlign: 'left', lineHeight: '32px' as any, letterSpacing: 0 } },
          { id: item4, type: 'text', name: 'Help', x: 0, y: 0, width: 200, height: 32, parentId: frameId, text: { content: 'Help', fontSize: 14, fontWeight: 400, color: '#8a8a8a', textAlign: 'left', lineHeight: '32px' as any, letterSpacing: 0 } },
        ],
      }
    },
  },
